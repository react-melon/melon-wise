(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', '../Popup', 'react-tappable/lib/Tappable', 'melon-core/classname/cxBuilder', '../common/LockBody', '../Selector', '../util/date', '../babelHelpers'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('../Popup'), require('react-tappable/lib/Tappable'), require('melon-core/classname/cxBuilder'), require('../common/LockBody'), require('../Selector'), require('../util/date'), require('../babelHelpers'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.react, global.Popup, global.Tappable, global.cxBuilder, global.LockBody, global.Selector, global.date, global.babelHelpers);
        global.SeparatePopup = mod.exports;
    }
})(this, function (exports, _react, _Popup, _Tappable, _cxBuilder, _LockBody2, _Selector, _date, babelHelpers) {
    'use strict';
    ...
    var SeparatePopup = function (_LockBody) {
        ...
        SeparatePopup.prototype.componentWillUnmount = function componentWillUnmount() {
            _LockBody.prototype.componentWillUnmount.call(this);
        ...
        SeparatePopup.prototype.render = function render() {
            ...
            var end = _props.end;
            var rest = babelHelpers.objectWithoutProperties(_props, ['show', 'begin', 'end']);
